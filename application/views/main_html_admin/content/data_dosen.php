<div class="col-md-12 col-sm-12 col-xs-12">
  <div class="x_panel">
    ...
    <div class="x_content">
    <a href="#" class="btn btn-sm btn-success" data-toggle="modal" data-target=".bs-create-modal-md" onclick="showCreateDialog('<?=$dataDosen->num_rows()?>')">Tambah Data</a>
          ...
          <?php $nomor = 1;?>
            <?php foreach ($dataDosen->result_array() as $row) { ?>
                <tr>
                  ...
                  <td>
                    <a href="#" class="btn btn-sm btn-success" data-toggle="modal" data-target=".bs-update-modal-md" onclick="showDialogUpdate('<?=$row['kd_dosen']?>', this)">Ubah</a>
                    <a href="#" class="btn btn-sm btn-danger"  data-toggle="modal" data-target=".bs-delete-modal-sm"  onclick="showDialogDelete('<?=sha1($row['kd_dosen'])?>', this)">Hapus</a>
                  </td>
                </tr>
                <?php $nomor++; ?>
            <?php } ?>
          ...
          <div class="modal-body">
              <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <input type="text" id="nama_create" required="required" class="form-control col-md-7 col-xs-12" name="nama_dosen">
        ...
        <form id="formupdatematkul" data-parsley-validate class="form-horizontal form-label-left" method="POST" action="#">
          ...
          <div class="modal-body">
              ...
              <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <input type="text" id="nama" required="required" class="form-control col-md-7 col-xs-12" name="nama_dosen">
                  <input type="hidden" id="kd" required="required" class="form-control col-md-7 col-xs-12" name="kode_dosen">
    ...
    <script type="text/javascript">
      ...
      function showDialogUpdate(id, r){
          ...
          $.ajax({
            type: 'post',
            url: '<?=base_url('admin/index/post_get/dosen')?>/'+id,
            data: $('form').serialize(),
            success: function (i) {
              ...
              document.getElementById("kd").value=jsonObjectFinal.kode_dosen; 
              document.getElementById("nama").value=jsonObjectFinal.dosen; 
            }    
          });        
      }
      ...
      $(document).ready(function(){
        $('#formcreatematkul').on('submit', function(e){
          ...
          $.ajax({
            type: 'post',
            url: '<?=base_url('admin/index/post_dosen/create')?>',
        ...
        $('#formupdatematkul').on('submit', function(e){
          ...
          $.ajax({
            type: 'post',
            url: '<?=base_url('admin/index/post_dosen/update')?>',
        ...
        $('#yDel').on('click', function(e){
          ...
          $.ajax({
            type: 'post',
            url: '<?=base_url('admin/index/post_dosen/delete')?>/'+temp[0],
            data: $('form').serialize(),
            success: function (i) {
              if(i == 'true'){
