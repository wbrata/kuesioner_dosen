<div class="col-md-12 col-sm-12 col-xs-12">
  <div class="x_panel">
    ...
    <div class="x_content">
    <a href="#" class="btn btn-sm btn-success" data-toggle="modal" data-target=".bs-create-modal-md" onclick="showCreateDialog('<?=$dataMatkul->num_rows()?>')">Tambah Data</a>
          ...
          <?php $nomor = 1;?>
            <?php foreach ($dataMatkul->result_array() as $row) { ?>
                <tr>
                  ...
                  <td><?=$row['matkul']?></td>
                  <td>
                    <a href="#" class="btn btn-sm btn-success" data-toggle="modal" data-target=".bs-update-modal-md" onclick="showDialogUpdate('<?=$row['kd_matkul']?>', this)">Ubah</a>
                    <a href="#" class="btn btn-sm btn-danger"  data-toggle="modal" data-target=".bs-delete-modal-sm"  onclick="showDialogDelete('<?=sha1($row['kd_matkul'])?>', this)">Hapus</a>
                  </td>
                </tr>
                <?php $nomor++; ?>
            <?php } ?>
