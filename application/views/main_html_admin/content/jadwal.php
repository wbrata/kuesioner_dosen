          ...
          <?php $nomor = 1;?>
            <?php foreach ($dataKelas->result_array() as $row) { ?>
                <tr>
                  ...
                  <td>
                    <a href="#" class="btn btn-sm btn-success" data-toggle="modal" data-target=".bs-update-modal-md" onclick="showDialogUpdate('<?=$row['kd_kelas']?>', this)">Detail</a>
                  </td>
                </tr>
                <?php $nomor++; ?>
            <?php } ?>
          ...
          <div class="modal-body">
              <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <input type="text" id="nama_create" required="required" class="form-control col-md-7 col-xs-12" name="nama_matkul_dosen">
