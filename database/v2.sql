...
-- Membuang data untuk tabel kuisioner_dosen.tt_kritik_saran: ~0 rows (lebih kurang)
/*!40000 ALTER TABLE `tt_kritik_saran` DISABLE KEYS */;
INSERT INTO `tt_kritik_saran` (`kd_kritik_saran`, `kd_jadwal`, `kritiksarandosen`, `kritiksaranoffice`, `dosen_favorit`) VALUES
	(1, 1, 'as', 'a', 'test'),
	(2, 4, 'adsaasd', 'asd', 'test');
...
-- Membuang data untuk tabel kuisioner_dosen.tt_rating: ~1 rows (lebih kurang)
